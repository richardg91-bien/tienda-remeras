        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-4
                            border-b border-white/8 bg-surface/60 backdrop-blur-xl">
              <div className="flex items-center gap-3">
                ...
                {totalItems > 0 && (
                  <span className="badge-cyan">{totalItems}</span>
                )}
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-5 py-5 space-y-3">
              <AnimatePresence initial={false}>
                {items.length === 0 ? (
                  ...
                  >
                    <span className="material-symbols-outlined text-[64px] text-gray-800 mb-4">
                      shopping_bag
                    </span>
                    ...
                    <button
                      onClick={closeCart}
                      className="mt-6 btn-primary text-xs py-2.5 px-6"
                    >
                      Explorar Catálogo
                    </button>
                  </motion.div>
                      ...
                      <div className="flex flex-col flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <div className="flex items-center bg-surface rounded-xl overflow-hidden">
                            ...
                            <span className="text-sm font-black text-white w-7 text-center">
                              {item.quantity}
                            </span>
                            <button
                              onClick={() => updateQty(index, item.quantity + 1)}
